...
function Skills(props) {
    ...
    <div className="skills-wrapper">
            ...
            <div className='technologies'>
                <SkillIcon name="react" Icon={FaReact} IconProps={{ className: "react" }} />
                <SkillIcon name="python" Icon={PythonIcon} IconProps={{ className: "python w-24 h-24" }} />
                <SkillIcon name="js" Icon={FaJsSquare} IconProps={{ className: "js" }} />
                <SkillIcon name="css3" Icon={FaCss3Alt} IconProps={{ className: "css3" }} />
                <SkillIcon name="tailwind" Icon={SiTailwindcss} IconProps={{ className: "tailwind" }} />
                <SkillIcon name="nodejs" Icon={IoLogoNodejs} IconProps={{ className: "nodejs" }} />
                <SkillIcon name="html5" Icon={FaHtml5} IconProps={{ className: "html5" }} />
            </div>
