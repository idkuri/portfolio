...
function Pages(props) {
    ...
    const scrollToY = (y) => {
        // Scroll smoothly to a specific Y position
        window.scrollTo({
            top: y,
            behavior: 'auto', // or 'auto' if you want instant
        });
    };
                ...
                <ParallaxProvider scrollAxis='vertical' scrollContainer={scrollEl}>
                    <div className='pageContainer' ref={ref}>
                        ...
                        <Parallax onProgressChange={handleSkillProgress} speed={20}>
                            <section id="skills" className="min-w-screen min-h-screen">
                                <Skills headerPos={skillPos} />
                            </section>
                        </Parallax>
                        <Parallax onProgressChange={handleProjectProgress} speed={1}>
                            <section id="projects" className="min-w-screen min-h-screen">
